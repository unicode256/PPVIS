...
// PPVIS2.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CPPVIS2App, CWinApp)
...
// Единственный объект CPPVIS2App

CPPVIS2App theApp;


// Инициализация CPPVIS2App

BOOL CPPVIS2App::InitInstance()
{
